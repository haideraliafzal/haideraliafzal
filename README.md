...
<p align="center">
  <i>I build production AI — autonomous agents, voice AI, and RAG systems — on solid React, Node, and Laravel foundations.<br/>
  Lead architect of Studio98AI, a no-code platform where businesses build their own AI agents.</i>
</p>
...
```yaml
Name        : Haider Ali Afzal
Location    : Pakistan  (Open to Remote Worldwide)
Role        : AI Integration & Full-Stack Engineer · Lead Architect
Experience  : 9+ Years  ·  $100K+ earned on Upwork
Education   : BS Computer Science — FAST (NUCES), Islamabad
Stack       : React · Next.js · Node.js · Laravel · TypeScript
AI Focus    : Agentic AI · MCP · RAG · Voice AI · Automation
Building    : Studio98AI — No-Code AI Agent Platform 🚀
Currently   : LangGraph · Model Context Protocol · VAPI · Retell · n8n
```
...
- 🤖 **Autonomous AI agents & multi-agent systems** — LangGraph, MCP, tool/function calling, guardrails
- ☎️ **AI voice agents** — VAPI, Retell, ElevenLabs (inbound/outbound calls, booking, lead-qual)
- 📚 **RAG systems & AI assistants** — OpenAI, Claude, vector databases (Pinecone, Weaviate)
- ⚙️ **Workflow automation** — n8n, Make.com, Zapier with AI-enriched pipelines
- 🌐 **Full-stack web & mobile** — React, Next.js, Node.js, Laravel, React Native

---

## 🏗️ Featured — Studio98AI

> **Lead Architect** of [**Studio98AI**](https://studio98.ai) — a production platform where businesses build autonomous *"digital employee"* agents with **no code**: 100+ tools & skills, multi-credential handling, webhooks, scheduling, and deep full-stack integrations across their software stack. &nbsp;→ [**Live app**](https://app.studio98.ai)
...
![VAPI](https://img.shields.io/badge/VAPI-1A1A1A?style=for-the-badge&logo=v&logoColor=white)
![Retell](https://img.shields.io/badge/Retell_AI-5B21B6?style=for-the-badge&logo=retool&logoColor=white)
...
- **Production, not demos** — guardrails, monitoring, error handling, and docs
- **AI where it earns its place** — measurable value, not hype
- **Own it end to end** — you brief once, I deliver a working system
